...
|---|---|---|---|
| AC-GUEST-001 | `RMC-SPEC-GUEST-001.1` | GAP | `rmc_frontend/tests/e2e/guest-search.spec.ts` *(planned)* |
...
| AC-CFG-001 | `RMC-SPEC-CFG-001.1`, `RMC-SPEC-CXL-001.2` | GAP | `RefundPolicySnapshotImmutabilityTest.java` *(planned)* |
