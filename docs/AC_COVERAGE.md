...
**Companion to:** `docs/VALIDATION.md` Part 3 (v1.7) · `docs/SPEC.md` v1.0.29 · `docs/RESEARCH.md` v1.0.9  
...
| AC-GUEST-005 | `RMC-SPEC-GUEST-001.6`, `RMC-SPEC-UX-001.3`, `RMC-SPEC-ARCH-001`, `RMC-SPEC-PAY-002.1` | COVERED | `WebhookTruthIntegrationTest` + `BookingSuccessPage.jsx` (paid claims from server status only) |
| AC-GUEST-006 | `RMC-SPEC-GUEST-001.7` | COVERED | `EmailOutboxServiceTest` (BOOKING_RECEIVED includes reference; confirm remains separate) |
...
| AC-GUEST-011 | `RMC-SPEC-GUEST-001.2b`, `PROMO-001.1`, `.3`, `.4` | COVERED | `PromoCodeServiceTest` + home filter apply (success/failure alerts) |
| AC-GUEST-012 | `RMC-SPEC-GUEST-001.2c`, `UX-001.17` | COVERED | `RoomAvailabilityMapperFromPlanTest` (policySummary on offers) + `RoomPolicyInfoBadge.jsx` |
...
| AC-PAY-002 | `RMC-SPEC-NN-001.1`, `RMC-SPEC-ARCH-001`, `RMC-SPEC-PAY-002.1` | COVERED | `rmc_backend/.../integration/WebhookTruthIntegrationTest.java` |
...
| AC-PAY-004 | `RMC-SPEC-PAY-001.3`, `RMC-SPEC-ARCH-001.2` | COVERED | `MayaWebhookIdempotencyTest` + duplicate ledger skip in `MayaPaymentServiceTest` |
...
| AC-PAY-010 | `RMC-SPEC-PAY-002.2`, Appendix F.9 | COVERED | `rmc_backend/.../MayaAmountMismatchTest.java` |
| AC-PAY-011 | `RMC-SPEC-ARCH-001.4` | COVERED | `MayaPaymentEvidenceServiceTest` + evidence-failure does not block paid in `MayaPaymentServiceTest` |
...
| AC-CXL-003 | `RMC-SPEC-CXL-001.3`, `RMC-SPEC-CXL-001.4` | COVERED | `StaffRefundServiceTest` + `MayaRefundServiceTest` (incl. void→refund fallback on PY0045) |
| AC-CXL-004 | `RMC-SPEC-CXL-001.5`, `RMC-SPEC-CXL-001.6` | COVERED | `rmc_backend/.../GuestCancelAutoRefundTest.java` |
| AC-CXL-005 | `RMC-SPEC-CXL-001.7` | COVERED | `rmc_backend/.../GuestCancelAutoRefundFailureTest.java` |
| AC-CXL-006 | `RMC-SPEC-CXL-001.9`, `RMC-SPEC-UX-001.4` | COVERED | `GuestCancelRefundMessagingTest` + `BookingPage.jsx` (server copy; no complete claim until `COMPLETED`) |
| AC-CXL-007 | `RMC-SPEC-CXL-001.8` | COVERED | `rmc_backend/.../GuestCancelNoAutoRefundPayAtHotelTest.java` |
...
| AC-STAFF-011 | `RMC-SPEC-STAFF-001.2` | COVERED | `StaffBookingDetailResponse` + `StaffBookingPage` (createdAt, approve/reject actors, extras) |
| AC-STAFF-012 | `RMC-SPEC-STAFF-001.4d` | COVERED | `StaffConfigServiceRatePlanPricingTest` + `RatePlanManager` (primary nightly rate + date overrides) |
| AC-STAFF-013 | `RMC-SPEC-STAFF-001.4g`, `.4` | COVERED | `StaffConfigServiceAmenityConfigTest` + Rooms config Amenities tab + wizard Select add/remove |
| AC-SEC-001 | `RMC-SPEC-SEC-001.1`, `RMC-SPEC-IAM-001` | COVERED | `rmc_backend/.../StaffAuthSecurityTest.java` |
...
| AC-SEC-004 | `RMC-SPEC-SEC-001.2` | COVERED | `rmc_backend/.../obs/LogRedactionTest.java` + `ObservabilityBasicsTest.java` |
...
| AC-OBS-001 | `RMC-SPEC-OBS-001`, `RMC-SPEC-STACK-001.3` | COVERED | `rmc_backend/.../obs/ObservabilityBasicsTest.java` |
| AC-OBS-002 | `RMC-SPEC-OBS-001`, `RMC-SPEC-ARCH-001.3` | COVERED | `rmc_backend/.../obs/CorrelationIdTest.java` |
| AC-OBS-003 | `RMC-SPEC-OBS-001.2` | COVERED | `rmc_backend/.../obs/AlertSignalTest.java` |
...
| AC-CFG-004 | `RMC-SPEC-CFG-001.1b` | COVERED | `rmc_backend/.../RefundPolicyConfigServiceTest.java` (required description) |
...
| AC-UI-005 | `RMC-SPEC-UX-001.20` | MANUAL | Confirm dialog + loading overlay + toasts (`AppFeedbackProvider`) |
...
| Path | Helps prove |
|---|---|
| `rmc_backend/src/test/java/.../MayaPaymentServiceTest.java` | AC-PAY-001, AC-PAY-004, AC-PAY-007, AC-PAY-011 |
| `rmc_backend/src/test/java/.../MayaPaymentEvidenceServiceTest.java` | AC-PAY-011 |
| `rmc_backend/src/test/java/.../MayaAmountMismatchTest.java` | AC-PAY-010 |
| `rmc_backend/src/test/java/.../MayaWebhookIdempotencyTest.java` | AC-PAY-004 |
| `rmc_backend/src/test/java/.../integration/WebhookTruthIntegrationTest.java` | AC-PAY-002, AC-GUEST-005 |
| `rmc_backend/src/test/java/.../security/StaffAuthSecurityTest.java` | AC-SEC-001 |
...
| `rmc_backend/src/test/java/.../GuestCancelAutoRefundTest.java` | AC-CXL-004 |
| `rmc_backend/src/test/java/.../GuestCancelAutoRefundFailureTest.java` | AC-CXL-005 |
| `rmc_backend/src/test/java/.../GuestCancelRefundMessagingTest.java` | AC-CXL-006 |
| `rmc_backend/src/test/java/.../GuestCancelNoAutoRefundPayAtHotelTest.java` | AC-CXL-007 |
...
| `rmc_backend/src/test/java/.../obs/LogRedactionTest.java` | AC-SEC-004 |
| `rmc_backend/src/test/java/.../obs/ObservabilityBasicsTest.java` | AC-OBS-001, AC-SEC-004 |
| `rmc_backend/src/test/java/.../obs/CorrelationIdTest.java` | AC-OBS-002 |
| `rmc_backend/src/test/java/.../obs/AlertSignalTest.java` | AC-OBS-003 |
...
**Priority gaps — product hardening:** AC-INV-004, AC-STAFF-001.  
